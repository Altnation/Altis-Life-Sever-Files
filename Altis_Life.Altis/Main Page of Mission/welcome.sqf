...
_role1 = "Welcome to AltNation";
_role1names = ["Server Owner!!"];
_role2 = "CWY ReVzItsDaveo!";
_role2names = ["Server Admins"];
_role3 = "Detected Error!";
_role3names = [")"];
_role4 = "TacticalBacon!";
_role4names = [""];
_role8 = "Weston-Pierce!";
_role8names = [""];
 _role9 = "Wrice4!";
_role9names = [""];
